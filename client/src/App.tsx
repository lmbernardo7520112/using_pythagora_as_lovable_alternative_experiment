...
import CreateProperty from "./pages/CreateProperty"; // Importe a nova página
import EditProperty from "./pages/EditProperty";    // Importe a nova página
      ...
      <ThemeProvider defaultTheme="light" storageKey="ui-theme">
        <Router>
          <Routes>
            ...
            <Route path="/create-property" element={<ProtectedRoute><Layout><CreateProperty /></Layout></ProtectedRoute>} /> {/* Nova rota */}
            <Route path="/edit-property/:id" element={<ProtectedRoute><Layout><EditProperty /></Layout></ProtectedRoute>} /> {/* Nova rota */}
