...
export function PropertyDetails() {
  ...
  const handleBookingRequest = async () => {
    ...
    try {
      ...
      toast({
        title: "Erro",
        description: "Falha ao enviar solicitação de reserva",
        variant: "destructive",
      });
    } finally {
              ...
              <div className="flex items-center space-x-4">
                ...
                <div className="flex-1">
                  <h3 className="font-semibold text-lg text-gray-900">
                    Hospedado por {property.owner.fullName}
                  </h3>
                  <p className="text-gray-600">Anfitrião desde {format(new Date(property.owner.createdAt), 'MMMM yyyy')}</p>
